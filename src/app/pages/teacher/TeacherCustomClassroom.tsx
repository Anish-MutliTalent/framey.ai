...
export function TeacherCustomClassroom() {
      ...
      <div className="max-w-3xl mx-auto space-y-5">
        ...
        <div className="rounded-2xl p-4 flex items-center gap-3" style={{ background: headerColor }}>
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-base font-bold truncate" style={{ color: '#fff' }}>{cc?.name ?? 'Classroom'}</h2>
        ...
        {tab === 'classwork' && (
          <div className="space-y-5">
            ...
            {!loadingClasswork && classwork.length === 0 && (
              <div className="text-center py-12 text-sm" style={{ color: T.textMuted }}>No classwork yet.</div>
            )}
            {classwork.map(group => (
              <div key={group.topic}>
